  ...
  return (
    <div id="overview" className="pt-60 lg:pt-40 to-over">
      ...
      >
        ...
        >
          <p className="">
          C++ é uma linguagem de programação de propósito geral, tipada estaticamente, de alto nível e com suporte para múltiplos paradigmas. Foi desenvolvida como uma extensão da linguagem C, oferecendo a capacidade de realizar programação orientada a objetos, programação funcional e programação genérica, além de oferecer controle de baixo nível sobre o hardware. 
